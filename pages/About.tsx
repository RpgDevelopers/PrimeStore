        ...
        <div class="w-full max-w-[1280px] p-4 md:p-6 lg:p-10">
          ...
          >
            <div class="flex flex-col gap-4 text-center z-10 max-w-2xl animate-fade-in-up">
              <span class="text-white/80 text-sm font-semibold tracking-widest uppercase">Since 2023</span>
              ...
              <h2 class="text-white/90 text-lg md:text-xl font-medium leading-relaxed max-w-lg mx-auto mt-2">
                  A journey into sustainable luxury and timeless design, where every thread tells a story.
              </h2>
            </div>
               ...
               <div class="flex flex-col gap-10 md:gap-16 lg:flex-row items-center">
                  ...
                  <div class="flex flex-col gap-8 lg:w-1/2 lg:pl-10">
                     <div class="flex flex-col gap-4 text-left">
                        ...
                        <h2 class="text-[#111318] dark:text-white text-4xl md:text-5xl font-black leading-tight tracking-[-0.02em]">Born from a desire for slowness.</h2>
                        <p class="text-[#111318]/70 dark:text-gray-300 text-lg font-normal leading-relaxed">
                           Founded on the principles of slow fashion, we began in a small studio with a single goal: to create objects that last a lifetime. In a world obsessed with speed, we chose to take our time.
                        </p>
                        <p class="text-[#111318]/70 dark:text-gray-300 text-lg font-normal leading-relaxed">
                           Every piece is a testament to the belief that luxury lies in the details you can't see immediately, but feel eternally.
                        </p>
                     </div>
                     <div class="pt-4">
      ...
      <div class="relative w-full bg-background-light dark:bg-[#161b26] py-20 md:py-32">
         <div class="flex justify-center">
            <div class="flex flex-col w-full max-w-[960px] px-4 md:px-10 text-center">
               ...
               <h1 class="text-[#111318] dark:text-white text-3xl md:text-5xl font-black leading-tight tracking-tight mb-6">"Quality over quantity. Always."</h1>
               <p class="text-[#111318]/80 dark:text-gray-300 text-lg md:text-xl font-medium leading-relaxed max-w-3xl mx-auto">
                  Our mission is to redefine consumption through uncompromising craftsmanship. We believe in owning fewer, better things that age gracefully with you.
               </p>
               <div class="mt-10 flex justify-center">
                  <button class="flex min-w-[160px] cursor-pointer items-center justify-center rounded-lg h-12 px-6 bg-primary text-white text-base font-bold hover:bg-primary/90 transition-all shadow-lg shadow-primary/20">Our Philosophy</button>
               </div>
            </div>
         </div>
      </div>
         ...
         <div class="flex justify-center">
            <div class="flex flex-col w-full max-w-[1280px] px-4 md:px-10">
               <div class="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
                  <div>
                     <span class="text-primary font-bold uppercase tracking-wider text-sm mb-2 block">Behind the Scenes</span>
                     <h2 class="text-[#111318] dark:text-white text-3xl md:text-4xl font-bold leading-tight">The Process</h2>
                  </div>
                  <p class="text-[#111318]/60 dark:text-gray-400 max-w-md text-sm md:text-base">From the first sketch to the final stitch, transparency is at the heart of our creation process.</p>
               </div>
               <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {[
                     { num: '01', title: 'Ethical Sourcing', text: 'We partner directly with farms that prioritize soil health and fair wages, ensuring every material starts with integrity.', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAIJNmtOyb9h6_nYN30Tv0ny3Er189ISZnFJmA8io10y-bKACM-2bQ_OivwahJ3RSboyI5Kp0kwUwrQo5Ula-tXYyA92ZTvYAO3ZaK54T1lwnOFA4kSHXvOHijyRoq1xSDUzdJBybqCqVxN2uVcx2aCD4RdH7_6vgRevCTBpI0-5e4o7LiEgK_gxrVPBgxjUe3EYwtYo0Aod9_KeJqA4S8xO6exoumaqYJtXMFUug8cY0jJJrfNNAUE9CrAOIOCtShix2J73bkbfDUc' },
                     { num: '02', title: 'Timeless Design', text: 'Anti-trend by nature. Our studio focuses on silhouettes that transcend seasons, engineered for longevity.', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBBvbD6axk6VcOd38n-zAWeXJ7_lUufP0Nyi3w1KwSF4FIMpVueXPW5DjdBRb6kj7ytmHm2F0UEWscsU-NJbZ3YvsRIWUxV5tZKAz0FhBVdJRUwMU1-COpSbp8K0xVnbGBXzIKNUnjYq7w08HVXibIUUMnbE8PJS-NZmXKwDaCn4GNf0EyBj3BXhDokiCmll6TvIRYC0i71YVZ2FbmoUzEA3tpESazgBM6qRdmHeYZAGzija2n7w99tsYWpCUnJkHCT3gMLxSO44J9X', mt: true },
                     { num: '03', title: 'Master Craftsmanship', text: 'Hand-finished in our atelier. Every hem, button, and seam is inspected to meet our rigorous standards.', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCF3nK7bWcbazgAhg57FHEXL4ivIlu5d4R7CXvivrxBkHfbN1JR9s366ZJuKCQS7P-eimzQoWjv2x3LyDqT4vTx6-ydpREBPOgKB2ctQm4fCfdB0h2lvpGl_gDPBfcGXdWTbsL0xJtz5LckafRR7k94D80OWUEn2lnKLw3CpXnXtTV7z2IktgLMwdCnLKdDuQ4n7gVBpY1A973fWj-LSUNR9XqstOZIzu6vs9Cr5W_VQmhypEIkzP9qqzx3EekSIGEBNJ8iV0WsJo_C' }
                  ].map((item, i) => (
         ...
         <div class="flex justify-center">
            <div class="flex flex-col w-full max-w-[1280px] px-4 md:px-10">
               <div class="text-center mb-16">
                  <h2 class="text-[#111318] dark:text-white text-3xl md:text-4xl font-bold mb-4">Our Commitments</h2>
                  <p class="text-[#111318]/60 dark:text-gray-400 max-w-2xl mx-auto">Building a brand for the future means taking responsibility for our impact today.</p>
               </div>
               <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                  {[
                     { icon: 'recycling', title: '0% Plastic Packaging', text: "We've eliminated single-use plastics from our entire supply chain. Everything arrives in compostable or recycled materials." },
                     { icon: 'verified_user', title: 'Lifetime Warranty', text: "We stand behind our quality. If a seam rips or a button pops, we will repair it for free, forever." },
                     { icon: 'public', title: '1% for the Planet', text: "We donate 1% of our gross sales to environmental non-profits working to preserve natural landscapes." }
                  ].map((item, i) => (
            ...
            <div class="w-full max-w-[1280px] px-4 md:px-10">
               <div class="relative overflow-hidden rounded-2xl bg-[#111318] text-white py-16 px-8 md:px-20 text-center">
                  ...
                  <div class="relative z-10 flex flex-col items-center gap-6">
                     <h2 class="text-3xl md:text-4xl font-black tracking-tight">Ready to join the movement?</h2>
                     <p class="text-gray-300 max-w-lg text-lg">Discover the collection that embodies our philosophy.</p>
                     <div class="flex gap-4 mt-4">
                        ...
                        <button class="h-12 px-8 bg-transparent border border-white/30 text-white font-bold rounded-lg hover:bg-white/10 transition-colors">Read Journal</button>
                     </div>
                  </div>
               </div>
            </div>
